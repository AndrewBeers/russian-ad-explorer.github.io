...
;(function($, window, document) {
  ...
  F.show = function(result, type){
    ...
    $(".thumbnail").click(function() {
      ...
      getContentByIndex(parseInt($(this).children(".caption").children('.detail').children('.date_order_index').text()), 'date_order_index');

    $('.nav-item a[href="#specific"]').tab('show')
    });

    $('.thumbnail-tag').addClass("hidden");

    if (chosen_sort === 'ad_creation_date') {
      $('.ad_clicks_label').removeClass("hidden");
    }
    else {
      $('.' + chosen_sort + '_label').removeClass("hidden");
    }

  $('.thumbnail-data').each(function(i, obj) {
    var data_value = obj.innerHTML
    if (data_value != '[Unavailable]'){
    obj.innerHTML = number_formatter.format(data_value)
  }
  });

  $('.thumbnail-usd').each(function(i, obj) {
    var data_value = obj.innerHTML
    if (data_value != '[Unavailable]'){
    obj.innerHTML = usd_formatter.format(data_value)
  }
  });
